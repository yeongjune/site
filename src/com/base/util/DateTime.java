...
public class DateTime {
	...
	public static Date firstDateOfYear(int year){
		c = calendar(null, year, 0, 1, 0, 0, 0);
		return c.getTime();
	}
	public static Date firstDateOfYear(Date d){
		c = calendar(d, null, 0, 1, 0, 0, 0);
		return c.getTime();
	}
	public static Date firstDateOfYear(){
		c = calendar(null, null, 0, 1, 0, 0, 0);
		return c.getTime();
	}
	...
	public static Date lastDateOfYear(Date d){
		c = calendar(d, null, 0, 1, 0, 0, 0);
		c.add(Calendar.YEAR, 1);
		return c.getTime();
	}
	...
	/**
	 * 获取year年quarter季度的第一天，[Q1：1-3月；Q2：4-6月；Q3：7-10月；Q4：11-12月]
	 * @param year
	 * @param quarter 0-3
	 * @return
	 */
	public static Date firstDateOfQuarter(int year, int quarter){
		c = calendar(null, year, null, 1, 0, 0, 0);
		int month = quarter*3;
		c.set(Calendar.MONTH, month);
		return c.getTime();
	}
	/**
	 * 获取指定日期所属季度的第一天，[Q1：1-3月；Q2：4-6月；Q3：7-10月；Q4：11-12月]
	 * @param d
	 * @return
	 */
	public static Date firstDateOfQuarter(Date d){
		c = calendar(d, null, null, 1, 0, 0, 0);
	...
	/**
	 * 获取当前时间所属季度的最后一天，[Q1：1-3月；Q2：4-6月；Q3：7-10月；Q4：11-12月]
	 * @return
	 */
	public static Date firstDateOfQuarter(){
		c = calendar(null, null, null, 1, 0, 0, 0);
		int month = c.get(Calendar.MONTH);
		month = month/3*3;
		c.set(Calendar.MONTH, month);
	...
	/**
	 * 获取year年quarter季度的最后一天，[Q1：1-3月；Q2：4-6月；Q3：7-10月；Q4：11-12月]
	 * @param year
	 * @param quarter 0-3
	 * @return
	 */
	...
	/**
	 * 获取指定日期所属季度的最后一天，[Q1：1-3月；Q2：4-6月；Q3：7-10月；Q4：11-12月]
	 * @param d
	 * @return
	 */
	public static Date lastDateOfQuarter(Date d){
		c = calendar(d, null, null, 1, 0, 0, 0);
		int month = c.get(Calendar.MONTH);
		month = month/3*3+3;
		c.set(Calendar.MONTH, month);
